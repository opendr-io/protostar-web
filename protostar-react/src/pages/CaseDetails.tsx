              ...
              <div className="rounded-lg shadow-md py-4 px-6 border border-gray-600">
                <div className="flex-row">
                  ...
                  <form onSubmit={SubmitComment}>
                    ...
                    <textarea id='txtCommentField' className="block w-full p-3 mt-2 border border-gray-300 rounded-md resize-none focus:ring-black transition-colors duration-200" onChange={(e) => setComment(e.target.value)} rows={6} placeholder="Enter Comment (start with @agent to ask the AI agent a question)" required />
                  </form>
                </div>
              </div>
            )}
