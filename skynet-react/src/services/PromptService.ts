...
export default class PromptService
{
  ...
  public DetailsPrompt(question: string, details: any)
  {
    ...
    following question: "${question}. Answer it as detailed as you can. At the end of the response place 
    the following message: "If you would like a more detailed response that you will need to get the pro version of the application." Do not forget to
  ...
  public DetailsSummaryPrompt(details: any)
  {
    ...
    what I need to priortize for this particular entity. Answer it as detailed as you can. At the end of the response place 
    the following message: "If you would like a more detailed response that you will need to get the pro version of the application." Do not forget to
    place this message at the end. It's important for the message to be there. As mentioned be detailed with the response but also concise and 
    to the point.`;
    return finalPrompt; 
  ...
  public ThreatStatusPrompt(question: string, details: any)
  {
    ...
    you recognize and what kind of data it contains and suggest possible investigative directions. Answer it as best as you can. At the end of the response place 
    the following message: "If you would like a more detailed response that you will need to get the pro version of the application." Do not forget to
    place this message at the end. It's important for the message to be there. As mentioned be detailed with the response but also concise and 
    to the point.`;
    return finalPrompt;
  ...
  public AlertSummaryPrompt(details: any, specificDetails: any)
  {
    ...
    the overall entity: ${JSON.stringify(details)}. As previously mentioned give a summary but coorelate the importance between the alert and the overall entity. At the end of the response place 
    the following message: "If you would like a more detailed response that you will need to get the pro version of the application." Do not forget to
    place this message at the end. It's important for the message to be there. As mentioned be detailed with the response but also concise and 
    to the point.`;
    return finalPrompt;
  ...
  public AlertPrompt(question: string, details: any, specificDetails: any)
  {
    ...
    the two when answering the question. Answer it as best as you can. At the end of the response place 
    the following message: "If you would like a more detailed response that you will need to get the pro version of the application." Do not forget to
    place this message at the end. It's important for the message to be there. As mentioned be detailed with the response but also concise and 
    to the point.`;
    return finalPrompt;
  ...
  {
    let finalPrompt = `Can you give me a further summary and explain the security risks and mitigation steps based on this output: ${details}. Answer it as best as you can. At the end 
    of the response place the following message: "If you would like a more detailed response that you will need to get the pro version of the application."`;
    return finalPrompt;
  }
}
