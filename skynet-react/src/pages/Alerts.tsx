...
export function Alerts()
{
    ...
    return (
      <div className="relative min-h-screen mt-20">
        ...
        <div className="mx-10">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-10 pb-24 ">
           {entityDetails && entityDetails.map((card: any, index: any) => (
            <div className={`transition-all duration-300 ease-in-out ${expandedCardIndex === index ? 
              ...
              <div className={`${(expandedCardIndex === index) ? 'bg-[#080808]' : 'bg-[#1B1B1B]'} flex flex-row text-white h-full`}>
                <div className="px-10 py-6 w-5/12 ">
                  ...
                  <div>
                    <div className="text-white text-base pr-52">
                      {entityDetails[0][index] != '' && expandedCardIndex === index && (
                        <div className="bg-[#242124] px-4 py-8 rounded">
                          ...
                          <p><span className="font-semibold">Mitre Tactic: </span>{ entityDetails[9][index] }</p>
                ...
                <div className={`${expandedCardIndex === index ? 'block' : 'hidden'} w-7/12 p-6`}>
                  <div className="mb-4">
                    ...
                    <textarea onChange={handleChange} className="my-3 shadow resize-none appearance-none border bg-[#1B1B1B] rounded border-gray-300 w-full py-2 px-3 text-gray-300 leading-tight focus:outline-none focus:shadow-outline h-32"  placeholder="Type your question here..." />
                  ...
                  <div className="mb-24">
                    ...
                    <p className="overflow-visible">
                      <textarea readOnly={true} placeholder={llmOutput} className="bg-[#1B1B1B] border-gray-300 overflow-y-auto cursor-default my-3 shadow resize-none appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline h-96" />
                    </p>
                  </div>
                </div>
              </div>
  ...
  else
  {
    return (
      <div>
        <h1 className="pl-10 text-3xl font-bold pt-4 bg-black h-screen w-screen mt-20">Alerts</h1>
      </div>
    )
  }
}